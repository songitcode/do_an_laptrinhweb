...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('./asset/front-end/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('./asset/font-awesome/fontawesome-free-6.5.2-web/css/all.min.css') }}">
</head>
<style>
    ...
    <div class="header-top">
        <div class="nav-bar">
            <div class="logo-techgood top-left">
                <img src="{{ asset('./asset/imgs/logo.png') }}" alt="logo" width="70px" height="70px">
            </div>
